...
const Click = () => {
  ...
  const Clickbutton = () => {
    ...
    for (const label of gate_labels) {
      for (let i = 0; i < 5; i++) {
        ...
        if (element_dot) {
          ...
          for (let i = 0; i < 4; i++) {
            if (dot_y >= 150 + 110 * i - 30 && dot_y <= 150 + 110 * i + 30) {
              dot_info[1] = i;
            }
          }
        ...
        if (element_dot2_1 && element_dot2_2) {
          ...
          for (let i = 0; i < 4; i++) {
            if (
              dot_y_1 >= 150 + 110 * i - 30 &&
              dot_y_1 <= 150 + 110 * i + 30
            ) {
              dot_info2[2] = i;
            }
            if (
              dot_y_2 >= 150 + 110 * i - 30 &&
              dot_y_2 <= 150 + 110 * i + 30
            ) {
              dot_info2[3] = i;
            }
    ...
    // var url = "https://django-render-aumu.onrender.com/execute_python_code/"; // for deploy
    var url = "http://127.0.0.1:8000/execute_python_code/"; // for debug
    axios
      .post(url, {
  ...
  return (
    <div>
      ...
      <div style={{ position : "absolute", left: "100px"}}>
        <span style={{fontSize: "30px"}}>表示切替</span>
